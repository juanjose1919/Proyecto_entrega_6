...
st.sidebar.markdown(f'<h1 style="text-align: center; color:#F4D03F ;font-size:30px;">{"FACULTAD DE ECONOMIA"}</h1>', unsafe_allow_html=True)
...
st.markdown(f'<h1 style="color:#CB4335 ;font-size:25px;">{"Conclusiones intermedias"}</h1>', unsafe_allow_html=True)
st.write('Se evidencia que la menor correlación existe entre la totalidad de solidos disueltos en el agua y la cantidad de sulfato disuelta, seguido de la totalidad de solidos disueltos con el número de ph, y el nivel de dureza frente a la cantidad de sulfato disuelta, mientras que la mayor correlación es entre el nivel de ph y el nivel de dureza, siendo este de solo 0.15.')
